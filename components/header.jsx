...
export default function Header() {
  ...
  return (
    <header className="bg-[#0b0d14]/80 backdrop-blur-md border-b border-white/10 text-white sticky top-0 z-50">
      ...
      {isOpen && (
        <div className="md:hidden bg-[#0b0d14]/90 backdrop-blur-md border-t border-white/10 px-4 pb-4 space-y-2">
